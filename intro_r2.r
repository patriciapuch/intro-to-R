...
ggplot(mtcars_fact, aes(wt, mpg, color = cyl, size = hp)) +
  geom_point(shape = 15)
...
ggplot(mtcars_fact, aes(wt, mpg, col = vs, shape = vs, fill = vs)) +
  ...
  scale_color_brewer(name = "Engine", palette = "Set1") + 
  scale_fill_brewer(name = "Engine", palette = "Set1") + 
